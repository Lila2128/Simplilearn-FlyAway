...
<% String Response=(String) request.getAttribute("Response");
	...
	<div class="places-edit">
		<h3 class="section-heading"> Add Airlines </h3>
		<form action="airlinesNewServlet" method="get">
			<p class="Places-edit-column">
		  	<input type="hidden" value="<%=request.getParameter("username")%> " name="username"> 
				<b class="row-headings"> Airline:</b>
				<input class="input-box" type="text" name="airlines" required>
				<b class="row-headings"> Flight Name:</b>
				<input class="input-box" type="text" name="flightName" required>
				<b class="row-headings"> Capacity:</b>
				<input class="input-box" type="text" name="capacity" required>
				<input type="submit" value="Add Airlines" name="submit">		
		</form>
	</div>
</section>
